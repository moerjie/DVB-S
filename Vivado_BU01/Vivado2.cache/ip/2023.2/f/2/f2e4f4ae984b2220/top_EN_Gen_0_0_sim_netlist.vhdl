...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_EN_Gen is
  ...
  attribute SOFT_HLUTNM of sourceGen_i_2 : label is "soft_lutpair2";
...
sourceGen_i_1: unisim.vcomponents.LUT4
    generic map(
      INIT => X"2F20"
    )
        port map (
...
sourceGen_i_2: unisim.vcomponents.LUT4
    generic map(
      INIT => X"8000"
    )
        port map (
...
sourceGen_i_3: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
sourceGen_reg: unisim.vcomponents.FDRE
     port map (
      C => clk,
      CE => '1',
      D => sourceGen_i_1_n_0,
