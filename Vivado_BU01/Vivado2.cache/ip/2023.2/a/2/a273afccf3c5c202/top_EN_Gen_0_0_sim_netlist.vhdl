...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_EN_Gen is
  ...
  signal dec2binGen_i_1_n_0 : STD_LOGIC;
  signal dec2bin_cnt : STD_LOGIC_VECTOR ( 2 downto 0 );
  signal \dec2bin_cnt_reg_n_0_[0]\ : STD_LOGIC;
  signal \dec2bin_cnt_reg_n_0_[1]\ : STD_LOGIC;
  signal \dec2bin_cnt_reg_n_0_[2]\ : STD_LOGIC;
...
\dec2bin_cnt[0]_i_1\: unisim.vcomponents.LUT5
    generic map(
      ...
      I2 => cntR(0),
      I3 => cntR(1),
      I4 => \dec2bin_cnt_reg_n_0_[0]\,
      O => dec2bin_cnt(0)
    );
\dec2bin_cnt[1]_i_1\: unisim.vcomponents.LUT6
    generic map(
...
\dec2bin_cnt[2]_i_1\: unisim.vcomponents.LUT6
    generic map(
      ...
      I2 => cntR(2),
      I3 => sourceGen_i_4_n_0,
      I4 => sourceGen_i_3_n_0,
      I5 => \dec2bin_cnt_reg_n_0_[2]\,
      O => dec2bin_cnt(2)
    );
...
sourceGen_i_1: unisim.vcomponents.LUT6
    generic map(
      INIT => X"0000000F00000004"
        ...
        port map (
      I0 => sourceGen_i_3_n_0,
      I1 => \dec2bin_cnt_reg_n_0_[2]\,
      I2 => sourceGen_i_4_n_0,
...
sourceGen_i_3: unisim.vcomponents.LUT2
    generic map(
      INIT => X"7"
        ...
        port map (
      I0 => \dec2bin_cnt_reg_n_0_[0]\,
      I1 => \dec2bin_cnt_reg_n_0_[1]\,
      O => sourceGen_i_3_n_0
    );
