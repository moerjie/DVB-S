...
#
# Script generated by Vivado on Tue May 14 20:53:24 +0800 2024
# SW Build 4029153 on Fri Oct 13 20:14:34 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : top_wrapper.sh
...
#
# Usage        : top_wrapper.sh
#                top_wrapper.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                top_wrapper.sh [-reset_run]
#                top_wrapper.sh [-reset_log]
#                top_wrapper.sh [-help]
#
...
# script info
echo -e "top_wrapper.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./top_wrapper.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L xlconstant_v1_1_8 -L sim_clk_gen_v1_0_3 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot top_wrapper xil_defaultlib.top_wrapper xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim top_wrapper -key {Behavioral:sim_1:Functional:top_wrapper} -tclbatch cmd.tcl -protoinst "protoinst_files/top.protoinst" -log simulate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="F:/FPGA/Vivado23/Vivado/2023.2/data/xsim"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb top_wrapper.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./top_wrapper.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: top_wrapper.sh [-help]\n\
Usage: top_wrapper.sh [-step]\n\
Usage: top_wrapper.sh [-lib_map_path]\n\
Usage: top_wrapper.sh [-reset_run]\n\
Usage: top_wrapper.sh [-reset_log]\n\
Usage: top_wrapper.sh [-keep_index]\n\
Usage: top_wrapper.sh [-noclean_files]\n\n\
