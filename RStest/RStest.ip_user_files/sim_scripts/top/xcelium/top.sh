...
design_libs_elab="-libname xil_defaultlib -libname sim_clk_gen_v1_0_3 -libname xlconstant_v1_1_8 -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xil_defaultlib sim_clk_gen_v1_0_3 xlconstant_v1_1_8)
...
compile()
{
  ...
  xmvlog -work sim_clk_gen_v1_0_3 $xmvlog_opts \
