// -------------------------------------------------------------
// 
// File Name: F:\Git_Repository\DVB-S\HDL_Gen\DVBS_axi4stream\hdlsrc\DVBS_AXI4Stream\HeaderProcess.v
...
// Source Path: DVBS_AXI4Stream/DVB-S/DataSource_Scrambler/HeaderProcess
// Hierarchy Level: 2
// Model version: 1.65
// 
// -------------------------------------------------------------
...
module HeaderProcess
  ...
  reg  Relational_Operator1_out1;
  reg  Relational_Operator_out1;
  wire [7:0] Constant1_out1;  // uint8
  reg [7:0] Constant1_out1_1;  // uint8
  ...
  always @(posedge clk or negedge reset_n)
    begin : delayMatch2_process
      if (reset_n == 1'b0) begin
        Relational_Operator1_out1 <= 1'b0;
      end
      else begin
        if (enb) begin
  ...
  assign Multiport_Switch_out1 = (Relational_Operator_out1 == 1'b0 ? Constant1_out1_1 :
              simDataIn);
  ...
  assign Multiport_Switch1_out1 = (Relational_Operator1_out1 == 1'b0 ? Multiport_Switch_out1 :
