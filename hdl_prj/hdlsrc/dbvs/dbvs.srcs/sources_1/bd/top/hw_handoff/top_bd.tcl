...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set RS_Out_0 [ create_bd_port -dir O -from 7 -to 0 RS_Out_0 ]
  set ce_out_0 [ create_bd_port -dir O ce_out_0 ]

  # Create instance: RS1_0, and set properties
  set block_name RS1
  set block_cell_name RS1_0
  if { [catch {set RS1_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
  ...
  if { [catch {set alpharandomization_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $alpharandomization_0 eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
