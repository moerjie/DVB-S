...
elaborate()
{
  xelab --relax --debug typical --mt auto -L sim_clk_gen_v1_0_2 -L xil_defaultlib -L xlconstant_v1_1_5 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot top xil_defaultlib.top xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim top -key {Behavioral:sim_1:Functional:top} -tclbatch cmd.tcl -protoinst "protoinst_files/top.protoinst" -protoinst "protoinst_files/rs_en_test.protoinst" -log simulate.log
}
