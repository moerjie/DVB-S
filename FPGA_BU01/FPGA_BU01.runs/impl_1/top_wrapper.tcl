...
namespace eval ::optrace {
  variable script "F:/Git_Repository/DVB-S/FPGA_BU01/FPGA_BU01.runs/impl_1/top_wrapper.tcl"
...
OPTRACE "add files" START { }
  add_files -quiet F:/Git_Repository/DVB-S/FPGA_BU01/FPGA_BU01.runs/synth_1/top_wrapper.dcp
  set_msg_config -source 4 -id {BD 41-1661} -limit 0
  set_param project.isImplRun true
  add_files F:/Git_Repository/DVB-S/FPGA_BU01/FPGA_BU01.srcs/sources_1/bd/top/top.bd
  set_param project.isImplRun false
OPTRACE "read constraints: implementation" START { }
  read_xdc F:/Git_Repository/DVB-S/FPGA_BU01/FPGA_BU01.srcs/constrs_1/new/topConstrain.xdc
...
OPTRACE "link_design" START { }
  set_param project.isImplRun true
  link_design -top top_wrapper -part xc7k325tffg900-2 
