...
entity top_PolarityShift_0_0_PolarityShift is
  port (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity top_PolarityShift_0_0 is
  port (
    clk : in STD_LOGIC;
    rst_n : in STD_LOGIC;
    singleIn : in STD_LOGIC;
  ...
  attribute IP_DEFINITION_SOURCE of top_PolarityShift_0_0 : entity is "module_ref";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of top_PolarityShift_0_0 : entity is "PolarityShift,Vivado 2023.2";
end top_PolarityShift_0_0;

architecture STRUCTURE of top_PolarityShift_0_0 is
  signal \<const1>\ : STD_LOGIC;
  signal \^m_axis_data_tdata\ : STD_LOGIC_VECTOR ( 6 downto 0 );
  attribute X_INTERFACE_INFO : string;
  attribute X_INTERFACE_INFO of clk : signal is "xilinx.com:signal:clock:1.0 clk CLK";
  attribute X_INTERFACE_PARAMETER : string;
  attribute X_INTERFACE_PARAMETER of clk : signal is "XIL_INTERFACENAME clk, ASSOCIATED_BUSIF m_axis_data, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN top_util_ds_buf_0_0_IBUF_OUT, INSERT_VIP 0";
  attribute X_INTERFACE_INFO of m_axis_data_tvalid : signal is "xilinx.com:interface:axis:1.0 m_axis_data TVALID";
  attribute X_INTERFACE_PARAMETER of m_axis_data_tvalid : signal is "XIL_INTERFACENAME m_axis_data, TDATA_NUM_BYTES 1, TDEST_WIDTH 0, TID_WIDTH 0, TUSER_WIDTH 0, HAS_TREADY 0, HAS_TSTRB 0, HAS_TKEEP 0, HAS_TLAST 0, FREQ_HZ 100000000, PHASE 0.0, CLK_DOMAIN top_util_ds_buf_0_0_IBUF_OUT, LAYERED_METADATA undef, INSERT_VIP 0";
...
inst: entity work.top_PolarityShift_0_0_PolarityShift
     port map (
      clk => clk,
      m_axis_data_tdata(1) => \^m_axis_data_tdata\(6),
      m_axis_data_tdata(0) => \^m_axis_data_tdata\(0),
