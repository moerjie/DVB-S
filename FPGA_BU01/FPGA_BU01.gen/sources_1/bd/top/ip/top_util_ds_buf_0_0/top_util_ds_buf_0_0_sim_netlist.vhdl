...
-- Date        : Sat Jun  8 22:00:48 2024
-- Host        : MOERJIE_PC running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim
--               f:/Git_Repository/DVB-S/FPGA_BU01/FPGA_BU01.gen/sources_1/bd/top/ip/top_util_ds_buf_0_0/top_util_ds_buf_0_0_sim_netlist.vhdl
...
entity top_util_ds_buf_0_0_util_ds_buf is
  port (
  ...
  attribute C_BUFGCE_DIV of top_util_ds_buf_0_0_util_ds_buf : entity is 1;
  attribute C_BUFG_GT_SYNC : integer;
  attribute C_BUFG_GT_SYNC of top_util_ds_buf_0_0_util_ds_buf : entity is 0;
  attribute C_BUF_TYPE : string;
  attribute C_BUF_TYPE of top_util_ds_buf_0_0_util_ds_buf : entity is "IBUFDS";
  attribute C_MODE : string;
  attribute C_MODE of top_util_ds_buf_0_0_util_ds_buf : entity is "PERFORMANCE";
  attribute C_OBUFDS_GTE5_ADV : string;
  attribute C_OBUFDS_GTE5_ADV of top_util_ds_buf_0_0_util_ds_buf : entity is "2'b00";
  attribute C_REFCLK_ICNTL_TX : string;
  attribute C_REFCLK_ICNTL_TX of top_util_ds_buf_0_0_util_ds_buf : entity is "5'b00000";
  attribute C_SIM_DEVICE : string;
  attribute C_SIM_DEVICE of top_util_ds_buf_0_0_util_ds_buf : entity is "VERSAL_AI_CORE_ES1";
  attribute C_SIZE : integer;
  attribute C_SIZE of top_util_ds_buf_0_0_util_ds_buf : entity is 1;
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of top_util_ds_buf_0_0_util_ds_buf : entity is "util_ds_buf";
end top_util_ds_buf_0_0_util_ds_buf;

architecture STRUCTURE of top_util_ds_buf_0_0_util_ds_buf is
...
entity top_util_ds_buf_0_0 is
  ...
  attribute NotValidForBitStream of top_util_ds_buf_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of top_util_ds_buf_0_0 : entity is "top_util_ds_buf_0_0,util_ds_buf,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of top_util_ds_buf_0_0 : entity is "yes";
  attribute x_core_info : string;
  attribute x_core_info of top_util_ds_buf_0_0 : entity is "util_ds_buf,Vivado 2023.2";
end top_util_ds_buf_0_0;

architecture STRUCTURE of top_util_ds_buf_0_0 is
  ...
  attribute x_interface_parameter of IBUF_OUT : signal is "XIL_INTERFACENAME IBUF_OUT, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN top_util_ds_buf_0_0_IBUF_OUT, INSERT_VIP 0";
begin
U0: entity work.top_util_ds_buf_0_0_util_ds_buf
     port map (
      BUFGCE_CE(0) => '0',
      BUFGCE_CLR(0) => '0',
      BUFGCE_I(0) => '0',
